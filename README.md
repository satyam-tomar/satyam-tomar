...
- [Portfolio](https://satyam-tomar.github.io/My-Portfolio-/)
- [GitHub](https://github.com/satyam-tomar)
...
**AI & Machine Learning**  
TensorFlow, Scikit‑learn, LangChain, LlamaIndex, ChromaDB, RAG, LSTM, Pandas, NumPy

**Web Development**  
React, Node.js, Express.js, Flask, MongoDB, Tailwind CSS, HTML5, CSS3

**Programming Languages**  
Python, Java, SQL

**Developer Tools**  
Git, Docker, n8n, Postman
...
*Jun 2025 – Aug 2025*  
- Built a demand analysis portal handling 10k+ energy records, cutting manual reporting by 35%  
- Migrated legacy datasets and optimised DB schema for 30% faster queries  
- Implemented JWT authentication and role‑based access control

**Web Content Developer** @ Nischay Foundation  
*Jun 2024 – Jul 2024*  
- Updated 20+ WordPress pages to improve navigation and user engagement  
- Standardised UI layout to align with brand guidelines
